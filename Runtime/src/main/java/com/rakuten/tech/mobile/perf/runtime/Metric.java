...
public final class Metric {
     ...
     * By default the current metric will be prolonged and it keeps going with UI(Activity, Fragment and Webview) life cycle events, in case once after you start a metric there is no lifecycle event happened then your metric will not be recorded (As of know the minimum duration for a metric to be recorded is 5 secs).
