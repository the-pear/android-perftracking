...
public class TrackerShadow {
    ...
    @Implementation public static void on(Context context, Config config,  CachingObservable<LocationData> observableLocation) { /* noop */ }

    @Implementation public static void off() { /* noop */ }

    @Implementation public static void startMetric(String metricId) { mockTracker.startMetric(metricId); }

    @Implementation public static void prolongMetric() { mockTracker.prolongMetric(); }

    @Implementation public static void endMetric() { mockTracker.endMetric(); }
