...
public class BaseRequestTest extends RobolectricUnitSpec {
  ...
  @Test
  public void parseNetworkResponse_successResponse() throws UnsupportedEncodingException, ExecutionException, InterruptedException {
  ...
  @Test
  public void parseNetworkResponse_errorResponse() throws UnsupportedEncodingException, ExecutionException, InterruptedException {
  ...
  @Test
  public void parseNetworkResponse_withHeaderCachingInstruction() throws UnsupportedEncodingException, ExecutionException, InterruptedException {
  ...
  private class TestRequest extends BaseRequest<String> {
    ...
    protected String parseResponse(String response) throws VolleyError {
      if(mThrowException) throw new VolleyError("Throwing exception");
      return response;
    }
  }
