...
public class MockTracker extends TrackerImpl {
    ...
    private int count = 0;
    public int startMethod(Object object, String method) { return count++;}
    public int startUrl(Object url, String verb) {return count++;}
    public int startCustom(String measurementId) {return count++;}
}
