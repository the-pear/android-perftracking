...
public class CallDetourSpec extends UnitSpec {
    ...
    @Test void "should match if the input ownerClass or any of it's super classes is equal to the owner of the callDetour"() {
    ...
    @Test void "should not match if the input ownerClass or any of it's super classes is not equal to the owner of the callDetour"() {
    ...
    @Test void "should visit methodInstruction for the callDetour inputs"() {
